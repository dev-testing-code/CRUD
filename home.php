    ...
    background: yellow;
            ...
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-md-12 mb-2 text-left">
                        <div class="card">
                            <div class="card-body">
                                  <h4 class="text-center">ស្វែងរកការងារជាមួយពួកយើងឥឡូវនេះ</h4>
        ...
        <section id="list">
            <div class="container mt-3 pt-2">
                <h4 class="text-center">តោះចូលរួមជាមួយពួកយើង</h4>
                <hr class="divider">
                <?php
                ...
                <div class="card vacancy-list" data-id="<?php echo $row['id'] ?>">
                    <div class="card-body">
                        ...
                        <span><small>ជ្រើសរើស: <?php echo $row['availability'] ?></small></span>
                        <hr>
